...
## Project Structure
    ...
    ├── testapiautoconnecto_65377  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_65377`
...
2. Clone this repo and `cd testapiautoconnecto_65377`
